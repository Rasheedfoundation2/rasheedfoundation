            ...
            <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
                <div class="container header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img class="navbar-brand-regular" style= "max-width: 200px; height: auto;" src="assets/img/logo/Blue.png"
                        <?php print $ufile ?> alt="brand-logo">
                        <img class="navbar-brand-sticky" style= "max-width: 150px; height: auto;" src="assets/img/logo/Blue.png"
                        <?php print $ufile ?> alt="sticky brand-logo">
                    </a>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="portfolio" class="nav-link">Impact</a>
                        </li>
