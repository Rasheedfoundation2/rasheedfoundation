            ...
            <div class="col-12 col-md-5">
                ...
                <div class="welcome-thumb-wrapper mt-5 mt-md-0">
                    <span class="welcome-thumb-1">
                        <img class="welcome-animation d-block ml-auto" src="assets/img/welcome/goodsmile.jpg" alt="">
                    </span>
    ...
    <div class="container">
        ...
        <div>
            <div class="card mb-3" style="padding: 1.25rem;" onmouseover="this.style.boxShadow='0 0 10px rgba(0, 0, 0, 0.3)'" onmouseout="this.style.boxShadow='none'">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                    <p class="card-text" style="font-size:18px;">On World Youth day - children is suppose to learn, not Earn!</p>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="card mb-3" style="padding: 1.25rem;" onmouseover="this.style.boxShadow='0 0 10px rgba(0, 0, 0, 0.3)'" onmouseout="this.style.boxShadow='none'">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                    <p class="card-text" style="font-size:18px;">Free health camp with free madicince in kopar khairne sector-12 Navi Mumbai</p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="padding: 1.25rem;" onmouseover="this.style.boxShadow='0 0 10px rgba(0, 0, 0, 0.3)'" onmouseout="this.style.boxShadow='none'">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                    <p class="card-text" style="font-size:18px;">Republic Day Celebration with Fire Fighters</p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="padding: 1.25rem;" onmouseover="this.style.boxShadow='0 0 10px rgba(0, 0, 0, 0.3)'" onmouseout="this.style.boxShadow='none'">
                <div class="row g-0">
                <div class="col-md-4">
                    <img src="assets/img/welcome/student.jpg" style="height:150px; width:100%" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                    <p class="card-text" style="font-size:18px;">Donated Pongal (Break fast) at Jai Hind Urdu School Chittoor(A.P) to 300 people who lost there home due to flood.</p>
                    </div>
                </div>
                </div>
            </div>
